...
md`# Story timeline vis v7 (Tighter control bar, fixed in-story display)`
)}
...
function _109(Inputs,povStopsVisible){return(
Inputs.table(povStopsVisible.slice(0, 15))
)}

function _110(Inputs,currentChapter,$0,jumpToChapter,jumpToPov,$1,$2,prevPovStop,nextPovStop){return(
Inputs.table([{
  currentChapter,
  currentUnit: $0.value,
  jumpToChapter: jumpToChapter?.chapter ?? null,
...
function _dashboard(width,rightMargin,html,controlsBar,currentChapterLabel,render,legendPanel,infoPanelNode)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["Inputs","povStopsVisible"], _109);
  main.variable(observer()).define(["Inputs","currentChapter","mutable currentUnit","jumpToChapter","jumpToPov","mutable lastHandledChapterJump","mutable lastHandledPovJump","prevPovStop","nextPovStop"], _110);
  ...
  main.variable(observer("dashboard")).define("dashboard", ["width","rightMargin","html","controlsBar","currentChapterLabel","render","legendPanel","infoPanelNode"], _dashboard);
  return main;
}
